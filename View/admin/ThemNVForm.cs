...
namespace quản_lý_bán_hàng
{
    public partial class ThemNVForm : Form
    {
                ...
                else
                {
                 ...
                 //   MemoryStream hinh = new MemoryStream();
                    ...
                    else if (verif())
                    {
                        ...
                        if (nv.themNV(msnv,hoten,gioitinh,namsinh,diachi,username,password))
                        {
        ...
        bool verif()
        {
            if ((textBoxMsnv.Text.Trim() == "") || (textBoxHoten.Text.Trim() == "") || (textBoxDiaChi.Text.Trim() == "") || (textBoxPassword.Text.Trim() == "") || (textBoxUsername.Text.Trim() == "") )
            {
                return false;
            }
            else
