...
namespace quản_lý_bán_hàng
{
    public partial class QLNVForm : Form
    {
        ...
        {
            SqlCommand command = new SqlCommand("SELECT msnv as 'Mã nhân viên',hoten as 'Họ và tên',gioitinh as 'Giới tính',namsinh as 'Ngày sinh',diachi as 'Địa chỉ',username,password FROM NHANVIEN");
        ...
        private void buttonSua_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                   ...
                   // pictureBoxHinh.Image.Save(pic, pictureBoxHinh.Image.RawFormat);
                    ...
                    try
                    {
                        if (nv.suaNV(msnv, hoten, gioitinh, namsinh, diachi, user, pass))
                        {
            ...
            bool verif()
            {
                if (textBoxMaNV.Text.Trim() == "" || textBoxHoTen.Text.Trim() == "" || textBoxDiaChi.Text.Trim() == "" || textBoxPass.Text.Trim() == "" || textBoxUser.Text.Trim() == "" )
                {
                    return false;
                }
                else
        ...
        private void dataGridViewNV_CellClick(object sender, DataGridViewCellEventArgs e)
        {
           ...
           // MemoryStream picture = new MemoryStream(pic);
            ...
            textBoxUser.Text = dataGridViewNV.CurrentRow.Cells[5].Value.ToString();
            textBoxPass.Text = dataGridViewNV.CurrentRow.Cells[6].Value.ToString();
        }
