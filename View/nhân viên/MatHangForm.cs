...
namespace quản_lý_bán_hàng
{
    public partial class MatHangForm : UserControl
    {
        ...
        private void MatHangForm_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand command = new SqlCommand("SELECT mahang as 'Mã mặt hàng',loaihang as 'Loại hàng',tenhang as 'Tên mặt hàng',gia as 'Giá/sản phẩm',soluong as 'Số lượng' FROM HANGHOA");
        ...
        private void buttonSua_Click(object sender, EventArgs e)
        {
            ...
            else
            {
             ...
             //   pictureBoxHinh.Image.Save(pic, pictureBoxHinh.Image.RawFormat);
                ...
                else if (mathang.updateHang(mahang,loaihang, tenhang, gia, soluong))
                {
        ...
        private void buttonTimKiem_Click(object sender, EventArgs e)
        {
            ...
            if (radioButtonMaMH.Checked)
            {
                ...
                {
                    SqlCommand command = new SqlCommand("SELECT mahang as 'Mã mặt hàng',loaihang as 'Loại hàng',tenhang as 'Tên mặt hàng',gia as'Giá',soluong as 'Số lượng' FROM HANGHOA");
                    dataGridViewMatHang.DataSource = mathang.layHangHoa(command);
                }
                else
                {
                    ...
                    try
                    {
                        ...
                        SqlCommand command = new SqlCommand("SELECT mahang as 'Mã mặt hàng',loaihang as 'Loại hàng',tenhang as 'Tên mặt hàng',gia as'Giá',soluong as 'Số lượng' FROM HANGHOA WHERE mahang=" + mamh);
                        dataGridViewMatHang.DataSource = mathang.layHangHoa(command);
                    }
                    catch
                    {
            ...
            else
            {
                ...
                else
                {
                    try
                    {
                        ...
                        SqlCommand command = new SqlCommand("SELECT mahang as 'Mã mặt hàng',loaihang as 'Loại hàng',tenhang as 'Tên mặt hàng',gia as'Giá',soluong as 'Số lượng' FROM HANGHOA WHERE tenhang LIKE '%" + mamh + "%'");
                        dataGridViewMatHang.DataSource = mathang.layHangHoa(command);
                    }
                    catch
                    {
